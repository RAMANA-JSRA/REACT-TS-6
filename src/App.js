  ...
  return (
    <div className="App">
      <header className="header bg-primary text-white py-5 text-center">
        <h1 className="name">RAMANA JSRA</h1>
        <p className="job-title">Mern Stack Developer</p>
      </header>
      ...
      <section className="about py-5">
        <div className="container">
          ...
          <p>
            I'm a passionate Mern Stack Developer with expertise in JavaScript,
      ...
      <section className="contact py-5 bg-primary text-white">
        <div className="container">
          ...
          <p>Email: ramana12js@gmail.com</p>
          <p>
            LinkedIn:{" "}
            <a
              href="https://www.linkedin.com/in/ramana-j-s-28628a227/"
              target="_blank"
